...
def generate_linear_comparison(nr_problems: int, min_depth: int, max_depth: int, seed: int = None, data_folder: str = DATA_FOLDER) -> List[Dict[str, str]]:
    ...
    return [{
        ...
        "tree": mwp.tree if mwp.tree is not None else None,
        # "distractors": mwp.distractors or {}
    } for mwp in mwps]
...
if __name__ == "__main__":
    # Test functions by generating small samples and printing to terminal
    print("Testing generate_linear_comparison:")
    samples = generate_linear_comparison(nr_problems=1, min_depth=2, max_depth=2, seed=42)
    for i, sample in enumerate(samples):
        print(f"Sample {i+1}: {sample}")
        print('-------------------------------------------------------------------------')
    
    print("\nTesting generate_linear_transfer:")
    samples = generate_linear_transfer(nr_problems=1, min_depth=2, max_depth=2, seed=42)
    for i, sample in enumerate(samples):
        print(f"Sample {i+1}: {sample}")
        print('-------------------------------------------------------------------------')
    
    print("\nTesting generate_linear_partwhole:")
    samples = generate_linear_partwhole(nr_problems=1, min_width=4, max_width=4, seed=42)
    for i, sample in enumerate(samples):
        print(f"Sample {i+1}: {sample}")
        print('-------------------------------------------------------------------------')
    
    print("\nTesting generate_nonlinear_comparison:")
    samples = generate_nonlinear_comparison(nr_problems=1, min_depth=2, max_depth=2, seed=42)
    for i, sample in enumerate(samples):
        print(f"Sample {i+1}: {sample}")
        print('-------------------------------------------------------------------------')
    
    print("\nTesting generate_moved_linear_comparison:")
    samples = generate_moved_linear_comparison(nr_problems=1, depth=2, move_idx=1, seed=42)
    for i, sample in enumerate(samples):
        print(f"Sample {i+1}: {sample}")
        print('-------------------------------------------------------------------------')