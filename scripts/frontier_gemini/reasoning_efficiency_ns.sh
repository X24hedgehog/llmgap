...
#SBATCH --output=/cluster/home/tunguyen1/llmgap/out/frontier_gemini/logs/re-ns-%j.out
#SBATCH --error=/cluster/home/tunguyen1/llmgap/out/frontier_gemini/logs/re-ns-%j.err
...
python src/run_inference_frontier_gemini.py \
  ...
  --mode before \
  --data-csv reasoning-efficiency/experiments/proof_search/out/next_subquestion_pairs.csv \
  --out-dir out/frontier_gemini \
  --suffix _reasoning_efficiency
