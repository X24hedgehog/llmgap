...
#SBATCH --output=/cluster/home/tunguyen1/llmgap/out/frontier_gemini/logs/re-ca-%j.out
#SBATCH --error=/cluster/home/tunguyen1/llmgap/out/frontier_gemini/logs/re-ca-%j.err
...
python src/run_inference_frontier_gemini.py \
  ...
  --task correct_answer \
  --mode before \
  --data-csv reasoning-efficiency/experiments/proof_search/out/correct_answer_pairs.csv \
