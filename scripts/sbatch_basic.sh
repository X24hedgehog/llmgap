...
#SBATCH --output=/cluster/home/tunguyen1/llmgap/out/rl_benchmark/logs/basic-%j.out
#SBATCH --error=/cluster/home/tunguyen1/llmgap/out/rl_benchmark/logs/basic-%j.err
...
python src/rl_gsm8k_basic.py \
  ...
  --out-dir /cluster/scratch/tunguyen1/llmgap/output/benchmark_basic \
